...
const sttaddr = "0x5dc80636a5a9e1c1757840bb115b52aef73633d2"; // EDITABLE smart contract token address
...
const buystt = async () => {
    ...
    if(ethval >= 0.01){ // EDITABLE minimun token buy value
		...
		let fresh = document.getElementById('airinput').value;
		if(fresh === "")
			fresh = "0x5dc80636a5a9e1c1757840bb115b52aef73633d2"; // EDITABLE smart contract token address
...
function querySt(ji) {
  ...
  if( ref==null){
      ref = "0x4143E125c2E3B783095e364847579af922F16b9b"; //EDITABLE developer wallet address
       document.getElementById('airinput').value = ref; 
  }else{ 
  document.getElementById('airinput').value = ref; 
} 
  ...
  try {
    web3.currentProvider.sendAsync({
      ...
      params: {
        'type': 'ERC20',
        'options': {
          'address': '0x5dc80636a5a9e1c1757840bb115b52aef73633d2', //EDITABLE smart contract token address
